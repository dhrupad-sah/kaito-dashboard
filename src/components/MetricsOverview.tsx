...
export default function MetricsOverview({ data, isLoading }: MetricsOverviewProps) {
  ...
  const metrics = [
    ...
    },
    {
      ...
      value: data?.total_retweets?.toLocaleString() || '0',
      icon: (
    ...
    },
    {
      ...
      value: data?.total_quotes?.toLocaleString() || '0',
      icon: (
    ...
    },
    {
      ...
      value: data?.total_likes?.toLocaleString() || '0',
      icon: (
    ...
    },
    {
      ...
      value: data?.total_bookmarks?.toLocaleString() || '0',
      icon: (
    ...
    },
    {
      ...
      value: data?.total_smart_engagements?.toLocaleString() || '0',
      icon: (
    ...
    },
    {
      ...
      value: data?.total_community_engagements?.toLocaleString() || '0',
      icon: (
